...
#gernerating ILA for leds
set ip_name ila_leds
puts "Creating IP $ip_name"
create_ip -name ila -vendor xilinx.com -library ip -module_name $ip_name
set_property -dict [list CONFIG.C_PROBE1_WIDTH        {1} \
...
#gernerating ILA for buttons
set ip_name ila_ctrl
puts "Creating IP $ip_name"
create_ip -name ila -vendor xilinx.com -library ip -module_name $ip_name
set_property -dict [list CONFIG.C_PROBE1_WIDTH        {4} \
                         CONFIG.C_PROBE0_WIDTH        {1}\
...
#set_property -dict [ list CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50}] [get_ips $ip_name]
set_property generate_synth_checkpoint false [get_files $ip_name.xci]
generate_target {all} [get_ips $ip_name]
...
set_property -dict [list CONFIG.pcie_blk_locn {PCIE4C_X1Y1} CONFIG.select_quad {GTY_Quad_227}] [get_bd_cells xdma_0]
